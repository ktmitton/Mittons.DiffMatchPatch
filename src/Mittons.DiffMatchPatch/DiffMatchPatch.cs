...
//             }
//             StringBuilder text = new($"@@ -{coords1} +{coords2} @@\n");
//             // Escape the body of the patch with %xx notation.
//             foreach (Diff aDiff in this.diffs)
//             {
//                 text.Append(aDiff.Operation switch
//                 {
//                     Operation.INSERT => '+',
//                     Operation.DELETE => '-',
//                     Operation.EQUAL => ' ',
...
//         public TimeSpan? DiffTimeout = TimeSpan.FromSeconds(1);
...
//          */
//         public IEnumerable<Diff> diff_main(string text1, string text2, bool checklines = true)
//         {
...
//         private IEnumerable<Diff> SplitPrefixAndSuffix(
//             string text1,
//             string text2,
//             bool checklines,
...
//          * @return List of Diff objects.
//          */
//         private IEnumerable<Diff> diff_main(string text1, string text2, bool checklines,
//             CancellationToken cancellationToken)
//         {
...
//             var diffs = diff_cleanupMerge(SplitPrefixAndSuffix(text1, text2, checklines, cancellationToken));
...
//          * @return List of Diff objects.
//          */
//         private IEnumerable<Diff> diff_compute(string text1, string text2,
...
//                 foreach (var diff in diff_main(text1_a, text2_a, checklines, cancellationToken))
//                 {
//                     yield return diff;
//                 }
//                 yield return new Diff(Operation.EQUAL, mid_common);
//                 foreach (var diff in diff_main(text1_b, text2_b, checklines, cancellationToken))
//                 {
//                     yield return diff;
//                 }
//             }
...
//             foreach (var diff in diff_bisect(text1, text2, cancellationToken))
//             {
//                 yield return diff;
//             }
//         }
...
//             List<Diff> diffs = diff_main(text1, text2, false, cancellationToken).ToList();
...
//                             {
//                                 // Overlap detected.
//                                 return diff_bisectSplit(text1, text2, x1, y1, cancellationToken);
//                             }
//                         }
//                     }
//                 }
...
//             {
//                 diffs[i] = diffs[i] with { Text = string.Join("", diffs[i].Text.Select(hash => lineArray[hash])) };
//             }
//             // foreach (Diff diff in diffs)
//             // {
//             //     text = new StringBuilder();
//             //     var temp = string.Join("", diff.Text.Select(hash => lineArray[hash]));
...
//         public int diff_commonOverlap2(string text1, string text2)
//         {
//             int n = Math.Min(text1.Length, text2.Length);
...
//                 return 0;
//             }
//             var segment1 = text1.AsSpan(text1.Length - n);
//             var segment2 = text2.AsSpan();
...
//             return n;
//         }
//         public int diff_commonOverlap(string left, string right)
//         {
...
//             var leftSpan = left.AsSpan(left.Length - maximumOverlap);
//             var rightSpan = right.AsSpan(0, maximumOverlap);
...
//             {
//                 if (rightSpan.StartsWith(leftSpan[i..], StringComparison.Ordinal))
//                 {
//                     best = maximumOverlap - i;

//                     continue;
//                 }

//                 if (!leftSpan.Contains(rightSpan[..(i + 1)], StringComparison.Ordinal))
//                 {
//                     break;
//                 }
//             }
...
//         private const byte HALF_MATCH_PREFIX1 = 0;
//         private const byte HALF_MATCH_SUFFIX1 = 1;
//         private const byte HALF_MATCH_PREFIX2 = 2;
//         private const byte HALF_MATCH_SUFFIX2 = 3;
//         private const byte HALF_MATCH_COMMON_MIDDLE = 4;
...
//                         diffs[equalities.Peek() + 1] = diffs[equalities.Peek() + 1] with
//                         {
...
//                             diffs[pointer - 1] = diffs[pointer - 1] with
//                             {
...
//                             diffs[pointer - 1] = new(Operation.INSERT, insertion[..^overlap_length2]);
//                             diffs[pointer + 1] = new(Operation.DELETE, deletion[overlap_length2..]);
//                             pointer++;
//                         }
//                     }
//                     pointer++;
...
//                         {
//                             diffs[pointer - 1] = diffs[pointer - 1] with { Text = bestEquality1 };
//                         }
//                         else
//                         {
...
//                                      new Diff(Operation.DELETE, lastEquality));
//                         // Change second copy to insert.
//                         diffs[equalities.Peek() + 1] = diffs[equalities.Peek() + 1] with { Operation = Operation.INSERT };
...
//         public IEnumerable<Diff> GetNextDiffRange(IEnumerable<Diff> diffs)
//         {
//             int pointer = 0;
//             int count_delete = 0;
//             int count_insert = 0;
...
//             int count_equal = 0;
//             int count_update = 0;
//             string text_update = string.Empty;
//             string text_delete = string.Empty;
//             string text_insert = string.Empty;
//             string text_equal = string.Empty;
//             StringBuilder updatedText = new();
//             StringBuilder deletedText = new();
//             StringBuilder insertedText = new();
//             StringBuilder equalText = new();
//             int commonlength;
//             foreach (var diff in diffs)
//             {
...
//                 {
//                     case Operation.INSERT:
//                         insertedText.Append(diff.Text);
//                         ++count_insert;
//                         break;
//                     case Operation.DELETE:
//                         deletedText.Append(diff.Text);
//                         ++count_delete;
//                         break;
//                     case Operation.EQUAL:
...
//                         {
//                             count_equal = 1;
//                             equalText.Append(diff.Text);

//                             break;
//                         }

//                         text_insert = insertedText.ToString();
//                         text_delete = deletedText.ToString();
...
//                             foreach (var newDiff in diff_compute(text_delete, text_insert, true, default))
//                             {
//                                 yield return newDiff;
//                             }

//                             continue;
//                         }

//                         text_equal = equalText.ToString();
//                         equalText = new();

//                         var isFirstEqual = true;
//                         foreach (var newDiff in diff_compute($"{text_equal}{text_delete}", $"{text_equal}{text_insert}", true, default))
//                         {
//                             if (newDiff.Operation != Operation.EQUAL)
//                             {
//                                 yield return newDiff;
...
//          * @param diffs List of Diff objects.
//          */
//         public IEnumerable<Diff> diff_cleanupMerge(IEnumerable<Diff> diffs)
//         {
//             // Add a dummy entry at the end.
//             //diffs.Add(new Diff(Operation.EQUAL, string.Empty));
//             int pointer = 0;
...
//                         break;
//                     case Operation.EQUAL:
//                         var mergeEqualOperations = count_delete + count_insert == 0;
//                         if (mergeEqualOperations)
//                         {
//                             equalText.Append(diff.Text);
//                             break;
//                         }

//                         var emitDeleteOnly = count_insert == 0;
//                         var emitInsertOnly = count_delete == 0;

//                         if (emitDeleteOnly)
//                         {
//                             yield return new Diff(Operation.DELETE, deletedText.ToString());
...
//                         if (emitInsertOnly)
//                         {
//                             yield return new Diff(Operation.INSERT, insertedText.ToString());
...
//                         // If there's a common prefix for the insert and delete, add it to the running equal operation
//                         commonlength = diff_commonPrefix(text_insert, text_delete);
//                         if (commonlength != 0)
//                         {
//                             equalText.Append(text_insert[..commonlength]);

//                             text_insert = text_insert[commonlength..];
//                             text_delete = text_delete[commonlength..];
//                         }

//                         // Get the running equal operation and reset it
//                         text_equal = equalText.ToString();
//                         equalText = new();

//                         // If there was a running equal operation, it preceeds the inserts and deletes, so emit it
//                         if (text_equal.Length > 0)
//                         {
//                             yield return new Diff(Operation.EQUAL, text_equal);
//                         }

//                         // If there's a common suffix, add it to the new running equal operation, it will follow the inserts and deletes
...
//                         // Emit the inserts and deletes
//                         yield return new Diff(Operation.DELETE, text_delete);
//                         yield return new Diff(Operation.INSERT, text_insert);
...
//             //                                 = diffs[pointer - count_delete - count_insert - 1].Append(text_insert[..commonlength]);
//             //                         }
//             //                         else
//             //                         {
...
//             //                     if (commonlength != 0)
//             //                     {
//             //                         diffs[pointer] = diffs[pointer].Prepend(text_insert.Substring(text_insert.Length
//             //                             - commonlength));
//             //                         text_insert = text_insert[..^commonlength];
//             //                         text_delete = text_delete[..^commonlength];
//             //                     }
...
//             //                 diffs[pointer - 1] = diffs[pointer - 1].Append(diffs[pointer]);
...
//             //             diffs[pointer] = diffs[pointer] with
//             //             {
//             //                 Text = diffs[pointer - 1].Text +
...
//             //             diffs[pointer - 1] = diffs[pointer - 1].Append(diffs[pointer + 1]);
//             //             diffs[pointer] = diffs[pointer] with
//             //             {
//             //                 Text = diffs[pointer].Text.Substring(diffs[pointer + 1].Text.Length)
...
//             List<Diff> diffs = diff_main(text1, text2, true).ToList();
//             if (diffs.Count > 2)
//             {
//                 diff_cleanupSemantic(diffs);
...
//                         // indices.
//                         List<Diff> diffs = diff_main(text1, text2, false).ToList();
//                         if (text1.Length > this.Match_MaxBits
...
//             {
//                 // Grow first equality.
//                 int extraLength = paddingLength - diffs[0].Text.Length;
//                 diffs[0] = diffs[0].Prepend(nullPadding.Substring(diffs[0].Text.Length));
...
//                 diffs[^1] = diffs[^1].Append(nullPadding.Substring(0, extraLength));
//                 patch.length1 += extraLength;
//                 patch.length2 += extraLength;
//             }
...
//                             else
//                             {
//                                 bigpatch.diffs[0] = bigpatch.diffs[0] with
//                                 {
//                                     Text = bigpatch.diffs[0].Text.Substring(diff_text.Length)
//                                 };
//                             }
//                         }
//                     }
...
//                             == Operation.EQUAL)
//                         {
//                             patch.diffs[patch.diffs.Count - 1] = patch.diffs[patch.diffs.Count - 1].Append(postcontext);
//                         }
//                         else
//                         {
...
//         private static partial Regex DiffLocationPattern();
