...
namespace Mittons.DiffMatchPatch.Benchmark.Original;
...
public class diff_match_patch
{
     ...
     * @return List of Diff objects.
     */
    public List<Diff> diff_compute(string text1, string text2,
     ...
     * @return List of Diff objects.
     */
    public List<Diff> diff_bisect(string text1, string text2,
        DateTime deadline)
    {
     ...
     */
    public List<Diff> diff_bisectSplit(string text1, string text2,
     ...
     */
    public Dictionary<char, int> match_alphabet(string pattern)
    {
